...
import 'package:dcm/pages/settings/categories/whisper_settings.dart';

import 'package:dcm/backend/utils/l10n_utils.dart';
import 'package:dcm/pages/settings/categories/about_app_settings.dart';
import 'package:dcm/pages/settings/categories/appearance_settings.dart';
import 'package:dcm/pages/settings/categories/keymap_settings.dart';
import 'package:dcm/pages/settings/categories/language_settings.dart';
import 'package:dcm/pages/settings/categories/player_settings.dart';
import 'package:dcm/pages/settings/categories/storage_settings.dart';
import 'package:dcm/pages/settings/categories/developer_settings.dart';
